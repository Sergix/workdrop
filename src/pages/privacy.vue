<template>
  <main class="px-8 max-w-2xl">
    <h1 class="font-semibold text-4xl leading-none">Workdrop Privacy Policy</h1>
    <h5
    ...
    <section>
      ...
      <ul>
        ...
        <li>
          ...
          this Agreement) refers to workdrop.
        </li>
        <li>
        ...
        <li>
          Website refers to workdrop, accessible from https://www.workdrop.app
        </li>
        <li>Service refers to the Website.</li>
        <li>Country refers to: South Carolina, United States</li>
        <li>
    ...
    <section>
      ...
      <p>
        ...
        by email at
        <a class="text-action" href="mailto:help@workdrop.app"
          >help@workdrop.app.</a
        >
      </p>
    </section>
